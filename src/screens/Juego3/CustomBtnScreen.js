        ...
        <SafeAreaView style={[GlobalStyles.androidSafeArea2, { alignItems: 'center', alignContent: 'center' }]}>
            <LinearGradient colors={['#00FFEB', '#285EE8']} style={GlobalStyles.screen}>
                ...
                <View style={[styles.apoyo, { opacity: ayuda, zIndex: zindex1 }]}>
                    <LinearGradient colors={['#00FFEB', '#285EE8']} style={GlobalStyles.screen}>
                        <Text style={{ fontFamily: "prueba2", marginTop: "5%", fontSize: 30 }}> ¿Como se juega?</Text>
                        <Text style={{ fontFamily: "prueba2", width: "75%", marginTop: "3%", textAlign: 'justify', fontSize: 15 }}>
                        ...
                        <Text style={{ fontFamily: "prueba2", width: "75%", marginTop: "2%", textAlign: 'justify', fontSize: 15 }}>
                        ...
                        <TouchableOpacity onPress={() => cerrar()}>
                            <Text style={{ fontFamily: "prueba2", width: "75%", marginTop: "5%", borderWidth: 2, fontSize: 30 }}> Cerrar</Text>
                        </TouchableOpacity>
                    </LinearGradient>
                </View>
